...
$(call inherit-product-if-exists, vendor/samsung/blaze4g/blaze4g-vendor.mk)

# Set en_US as default locale
PRODUCT_LOCALES := en_US

# blaze4g uses high-density artwork where available
...
DEVICE_PACKAGE_OVERLAYS += device/samsung/blaze4g/overlay

PRODUCT_BUILD_PROP_OVERRIDES += BUILD_UTC_DATE=0

PRODUCT_NAME := full_blaze4g
PRODUCT_DEVICE := blaze4g
PRODUCT_MODEL := SGH-T789
